...
export default function HeadTags() {
    ...
    return (
        ...
        <meta name="description" content='Inspiring being to live Joyfully Free is our mission. We re-connect to these values through meaningful conversations, weekly dry fasting, intensive workshops and pranic initiations.'/>
